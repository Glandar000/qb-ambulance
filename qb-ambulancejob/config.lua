...
Config.Locations = {
    ...
    ["vehicle"] = {
        [1] = vector4(-458.32, -331.92, 34.36, 80.79),
        [2] = vector4(-234.28, 6329.16, 32.15, 222.5),
    },
    ["helicopter"] = {
        [1] = vector4(-447.28, -312.57, 78.17, 52.26),
        [2] = vector4(-475.43, 5988.353, 31.716, 31.34),
    },
    ["armory"] = {
        [1] = vector3(-437.42, -318.54, 34.91),
    ...
    ["stash"] = {
        [1] = vector3(-436.44, -320.49, 34.91),
    },
    ["beds"] = {
        [1] = {coords = vector4(-466.54, -282.54, 35.84, 203.66), taken = false, model = 2117668672},
        [2] = {coords = vector4(-462.66, -281.54, 35.84, 3.79), taken = false, model = 2117668672},
        [3] = {coords = vector4(-458.77, -279.98, 35.84, 23.02), taken = false, model = 2117668672},
        [4] = {coords = vector4(-455.28, -278.21, 35.84, 21.01), taken = false, model = 2117668672},
        [5] = {coords = vector4(346.99, -590.48, 43.1, 336.32), taken = false, model = 2117668672},
        [6] = {coords = vector4(360.32, -587.19, 43.02, 152.08), taken = false, model = 2117668672},
        [7] = {coords = vector4(349.82, -583.33, 43.02, 152.08), taken = false, model = 2117668672},
        [8] = {coords = vector4(326.98, -576.17, 43.02, 152.08), taken = false, model = -2117668672},
	--- paleto
    ...
    ["stations"] = {
        [1] = {label = Lang:t('info.pb_hospital'), coords = vector4(-436.44, -320.49, 34.91, 20.79)}
    }
}
